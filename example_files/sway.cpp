...
void Custom::RobotControl()
{
    ...
    if(motiontime>4500 && motiontime<5000){
        cmd.mode = 1;
        cmd.roll = 0.8f;
    }

    if(motiontime>5000 && motiontime<5500){
        cmd.mode = 1;
        cmd.roll = -0.8f;
    }

    if(motiontime>5500 && motiontime<6000){
        cmd.mode = 1;
        cmd.bodyHeight = 0.0f;
    }

    if(motiontime>6000 && motiontime<6500){
        cmd.mode = 2;
    }

    if(motiontime>6500 && motiontime<11000){
        cmd.mode = 2;
        cmd.rotateSpeed = 1.0f;
    }
    if(motiontime>11000){
        cmd.mode = 1;
        cmd.rotateSpeed = 0.0f;
